...
citation.htr = function (text="", color="#5BC002", twitter=TRUE) {
  ## Required packages
  ...
  grid.text(as.character(ifelse(twitter, "@HunterRatliff1", "hunterratliff1@gmail.com")),
            x=unit(0.995, "npc"), y=unit(0.995, "npc"), just=c("right", "top"),
            gp=gpar(
              fontface = "italic",
              family="Open Sans",
              col = "#333F48",
